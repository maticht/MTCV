    ...
    <section id="skills" className="section radial-accent-bg">
        <div className="container">
            ...
            <div className="grid skills">
                <div className="card"><h4>Analysis & Requirements</h4><p>{skills.analysis}</p></div>
                <div className="card"><h4>Tools & Platforms</h4><p>{skills.tools}</p></div>
                <div className="card"><h4>System & Integration Design</h4><p>{skills.systemDesign}</p></div>
                <div className="card"><h4>Development</h4><p>{skills.development}</p></div>
                ...
                <div className="card"><h4>Methodologies & Communication</h4><p>{skills.methodologies}</p></div>
            </div>
        </div>
    </section>
)